...
Public Class frmTipoUsuario
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            objTipoUsuario.modificarTipoUsuario(CInt(txtIDProducto.Text), txtNombres.Text, txtDescripcion.Text, chkEstado.Checked)
            limpiarControles()
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        Try
            objTipoUsuario.eliminarTipoUsuario(CInt(txtIDProducto.Text))
            limpiarControles()
            habilitarBotones(False)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "SIST-REST 2025", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btnDarBaja_Click(sender As Object, e As EventArgs) Handles btnDarBaja.Click
        Try
            objTipoUsuario.darBajaTipoUsuario(CInt(txtIDProducto.Text))
            limpiarControles()
            habilitarBotones(False)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "SIST-REST 2025", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            If txtIDProducto.TextLength > 0 Then
                dtTipoUsuario = objTipoUsuario.buscarTipoUsuario(CInt(txtIDProducto.Text))
                If dtTipoUsuario.Rows.Count > 0 Then
                    habilitarBotones(True)
                    txtNombres.Text = dtTipoUsuario.Rows(0).Item(1)
                    txtDescripcion.Text = dtTipoUsuario.Rows(0).Item(2)
                    chkEstado.Checked = dtTipoUsuario.Rows(0).Item(3)
                Else
    ...
    Private Sub listar_tipo_usuarios()
